...
void snakeandladders::playSandL()
{
    ...
    while (y)
    {
        ...
        int roll = Die();
        cout << "Player " << currentPlayer << " rolled a " << roll << ". ";
        ...
        if (currentPlayer == name1)
        {
            if (player1Position + roll <= boardSize)
            {
                ...
                if (Snake(player1Position))
                {
                    cout << endl;
                    setcolor(12);
                    cout << "Oops! You landed on a snake. Go back!";
                    setcolor(7);
                    cout << endl;
                ...
                else if (Ladder(player1Position))
                {
                    cout << endl;
                    setcolor(2);
                    cout << "You climbed a ladder! Advance!";
                    setcolor(7);
                    cout << endl;
    ...
    while (1)
    {
        ...
        case 2:
            cout << "\n                    ********Rules********" << endl
                 ...
                 << "4. The (Q)ueen can move in any direction." << endl
                 << "5. Landing on the base of a ladder allows a player to climb to the top, advancing their position." << endl
                 << "6. Landing on the head of a snake forces a player to slide down to the tail, setting them back.\n"
                 << endl;
            break;
        case 3:
            return;
